...
BASEDIR_MOVIE = ADDON.getSettingString('movies_library') or 'special://profile/library/Movies/'
BASEDIR_TV = ADDON.getSettingString('tvshows_library') or 'special://profile/library/TVShows/'
"""
